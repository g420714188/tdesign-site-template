...
function define$1(hybrids) {
  ...
  globalThis.customElements.define(hybrids.tag, compile$1(hybrids));
  return hybrids;
}
...
function addClassNames(set2, value2) {
  if (value2) {
...
let instance;
var transition = globalThis.document && globalThis.document.startViewTransition !== void 0 && function transition2(template) {
  return function fn2(host, target) {
    if (instance) {
      console.warn(
        `${stringifyElement(
...
const getHeaderConfig = () => {
  ...
  const headerList2 = [
    { name: "\u8BBE\u8BA1", path: jumpLocation("/design"), type: "main", target: "_self" },
    { name: "\u57FA\u7840\u7EC4\u4EF6", path: jumpLocation("/vue/overview"), type: "base", target: "_self" },
    intranet ? { name: "\u884C\u4E1A\u7EC4\u4EF6", path: "/trade", type: "main", target: "_self" } : null,
    { name: "\u9875\u9762\u6A21\u677F", path: "https://tdesign.tencent.com/starter/", type: "main", target: "_self" },
    { name: "\u8D44\u6E90", path: jumpLocation("/source"), type: "main", target: "_self" },
    { name: "\u5173\u4E8E", path: jumpLocation("/about/introduce"), type: "main", target: "_self" }
  ].filter((item) => item);
...
const headerConfig$1 = getHeaderConfig();
const { headerList, baseComponentsLinks, baseComponentPrefix } = headerConfig$1;
[
...
function renderLinks$2(host, headerList2, platform, framework) {
  html`
    <a
...
define$2({
  ...
  render: (host) => {
    const { site, title, platform, framework, disabledTheme, collapseMenu } = host;
    return html`
      ${renderNotice(host)}
      <header class="TDesign-header">
        <div class="TDesign-header-inner">
          <div class="TDesign-header-left">
            <td-logo site="${site}" title="${title}"></td-logo>
          </div>
          <div class="TDesign-header-nav">
            ${collapseMenu ? html`
                ...
                ` : html`
                  ...
                  ${renderLinks$2(host, headerList, platform, framework)}
...
function renderLinks$1({ headerList: headerList2, baseComponentsLinks: baseComponentsLinks2, platform, framework }) {
  const gitLink = html`
...
function renderNav(host, nav, deep = 0) {
  ...
  const isActive2 = location.pathname === nav.path || location.hash.slice(1) === nav.path || location.pathname.endsWith(nav.path);
  const hasUpdate = () => {
  ...
  if (nav.children && nav.path) {
    return html`
      <div class="TDesign-doc-sidenav-group TDesign-doc-sidenav-group--deep${deep}">
        <a class="TDesign-doc-sidenav-group__title TDesign-doc-sidenav-link  ${isActive2 ? "active" : ""}" href="${nav.path}"
...
const getFooterConfig = () => {
  const footerLinks2 = [
    ...
    },
    {
      title: "\u5173\u4E8E",
      links: [
        { name: "\u5173\u4E8E\u6211\u4EEC", url: "https://everdt.com/new", target: "_blank" },
        { name: "\u8054\u7CFB\u6211\u4EEC", url: jumpLocation("/about/contact"), target: "_self" },
        { name: "\u610F\u89C1\u53CD\u9988", url: "https://support.qq.com/product/639009", target: "_blank" }
      ]
    }
  ];
  return footerLinks2;
...
<!--            </div>-->
      ...
      <div class="TDesign-doc-footer__bottom" style="${mobileBodyStyle2}">
        <div class="TDesign-doc-footer__inner">
          <p class="copyright">Copyright &copy; ${copyDate} ${locale.footer.company}. All Rights Reserved. ${locale.footer.copyright}</p>
